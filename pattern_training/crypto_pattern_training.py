...
input_file_1yr = "DIS2.csv"

print('input_file_1yr length', len(input_file_1yr))
...
def create_dataset(dataset, look_back=1):
	...
	for i in range(len(dataset)-look_back-1-forecastCandle):
		...
		# print('third_input', a)
		dataX.append(a)
		b = dataset[i + look_back + forecastCandle, 3]
...
# load the dataset
df = read_csv(input_file_1yr, header=None, index_col=None, delimiter=',', usecols=[0,1,2,3])
# df2 = read_csv(input_file_1yr, header=None, index_col=None, delimiter=',', usecols=[0,1,2,3])
df2_volume = read_csv(input_file_1yr, header=None, index_col=None, delimiter=',', usecols=[4])
...
file_name = "patternTrainingResults.csv" 
