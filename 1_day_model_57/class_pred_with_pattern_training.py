...
window_size, input_shape, dropout_value, activation_function, loss_function, optimizer = look_back, 5, 0.2, 'linear', 'binary_crossentropy', 'adam'
...
file_name = "class_pred_with_pattern_training_1day_with_volume_retraining.csv" 
