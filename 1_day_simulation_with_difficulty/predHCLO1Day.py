...
difficulty_input = "../difficulty_dataset.csv"
...
df4_difficulty = read_csv(difficulty_input, header=None, index_col=None, delimiter=',', usecols=[0])
...
file_name = "pred_1day_nn2_with_volume_difficulty_lookBack_730.csv" 
