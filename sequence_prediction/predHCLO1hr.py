...
train, test, train_volume_dataset, test_volume_dataset, test_rsi_dataset = dataset[0:train_size,:], dataset[train_size - look_back - (forecastCandle+1):train_size + (forecastCandle+1) + (sequenceNumber - 1),:], df2_volume[0:train_size-1,:], df2_volume[train_size - look_back - (forecastCandle+1)-1:train_size + (forecastCandle+1)-1], df3_rsi[train_size - look_back - (forecastCandle+1)-1:train_size + (forecastCandle+1)-1]
...
for i in range(8760+step, len(dataset)-10, step):
	...
	train, test, train_volume_dataset, test_volume_dataset, test_rsi_dataset = dataset[train_size-look_back-(forecastCandle+1+step)-9 - (sequenceNumber - 1):train_size,:], dataset[train_size - look_back - (forecastCandle+1):train_size + (forecastCandle+1) + (sequenceNumber - 1),:], df2_volume[train_size-look_back-(forecastCandle+1+step)-1:train_size-1,:], df2_volume[train_size - look_back - (forecastCandle+1)-1:train_size + (forecastCandle+1)-1], df3_rsi[train_size - look_back - (forecastCandle+1)-1:train_size + (forecastCandle+1)-1]
