...
input_file="1yr2hr_step_10_01_02_05.csv"
...
model = Sequential()
model.add(LSTM(100, dropout=0.2, recurrent_dropout=0.2, input_shape=(1, look_back)))
...
file_name = "lstm_upDown_2hr_step_05_result.csv" 
